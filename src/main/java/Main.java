...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Items> purchaseItems = List.of(
                new Movie("Avengers", 50, 143, 20),
        ...
        // Output
        /*
        Movie name = Avengers, price = 50.0, duration = 143.0, discount = 20.0, rewardPoints = 500.0
        ...
        Total cost with no discounts: 79.0 Total Cost: 49.5 Total Discount: 29.5 Total Reward Points: 790.0
        */
    }
}
